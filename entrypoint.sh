...
cp /tmp/speedtest-cli.json "$HOME/.config/ookla/"
...
echo "$CRON_SCHEDULE /app/speedtest_runner.sh >> /var/log/speedtest.log 2>&1" > /tmp/crontabs/speedtest
...
crond -f -l 8 -L /var/log/cron.log -c /tmp/crontabs
